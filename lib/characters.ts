...
export const CHARACTERS: CharacterDefinition[] = [
  ...
  { id: 'buto', name: 'Buto', role: 'Guardian', speed: 194, boost: 122, agility: 0.86, visualScale: 0.9, accent: '#82934b', copy: 'Benteng berjalan yang kuat menutup jalur dan menjaga penjara.', passiveName: 'Jangkauan Besar', passiveCopy: 'Kontak tangkap 21% lebih jauh dari karakter lain.', tagRange: 34, rescueRange: 32, boostMultiplier: 1.62, boostDrain: 31, baseChargeTime: .75, rescueShieldMs: 1500, tagCooldownMs: 500 },
  { id: 'jago', name: 'Jago', role: 'Chaser', speed: 229, boost: 92, agility: 1.14, visualScale: 1.2, accent: '#d92d43', copy: 'Pemburu agresif untuk menutup jarak sebelum target kembali.', passiveName: 'Ledakan Kejar', passiveCopy: 'Boost tercepat, tetapi menghabiskan energi lebih deras.', tagRange: 28, rescueRange: 32, boostMultiplier: 1.82, boostDrain: 34, baseChargeTime: .75, rescueShieldMs: 1500, tagCooldownMs: 500 },
  { id: 'raja', name: 'Raja', role: 'All-rounder', speed: 216, boost: 102, agility: 1.02, visualScale: 0.86, accent: '#55c932', copy: 'Komandan fleksibel untuk berganti antara serang dan bertahan.', passiveName: 'Reposisi Cepat', passiveCopy: 'Persiapan keluar benteng 27% lebih singkat.', tagRange: 28, rescueRange: 32, boostMultiplier: 1.68, boostDrain: 31, baseChargeTime: .55, rescueShieldMs: 1500, tagCooldownMs: 500 },
  { id: 'lala', name: 'Lala', role: 'Scout', speed: 224, boost: 100, agility: 1.24, visualScale: 1.16, accent: '#77b9df', copy: 'Pengintai lincah yang paling mudah menembus jalur rintangan.', passiveName: 'Langkah Sutra', passiveCopy: 'Parkour terjauh dengan biaya boost paling ringan.', tagRange: 27, rescueRange: 34, boostMultiplier: 1.7, boostDrain: 30, baseChargeTime: .68, rescueShieldMs: 1700, tagCooldownMs: 500 },
  { id: 'maria', name: 'Maria', role: 'Chaser', speed: 232, boost: 94, agility: 1.12, visualScale: 0.99, accent: '#df8b49', copy: 'Pemburu cepat yang efektif mengunci target secara beruntun.', passiveName: 'Tempo Tag', passiveCopy: 'Cooldown setelah menangkap 28% lebih singkat.', tagRange: 30, rescueRange: 32, boostMultiplier: 1.72, boostDrain: 32, baseChargeTime: .75, rescueShieldMs: 1500, tagCooldownMs: 360 },
  { id: 'kumis', name: 'Kumis', role: 'Guardian', speed: 188, boost: 128, agility: 0.82, visualScale: 1.3, accent: '#e2554a', copy: 'Penjaga terbesar dengan daya tahan dan wilayah tangkap luas.', passiveName: 'Benteng Hidup', passiveCopy: 'Boost terbesar dan jangkauan tangkap terluas.', tagRange: 36, rescueRange: 30, boostMultiplier: 1.58, boostDrain: 25, baseChargeTime: .8, rescueShieldMs: 1500, tagCooldownMs: 540 },
  { id: 'boke', name: 'Boke', role: 'Disruptor', speed: 202, boost: 116, agility: 0.88, visualScale: 1.05, accent: '#ef677c', copy: 'Pengacau garis depan yang kuat memecah formasi lawan.', passiveName: 'Tag Kasar', passiveCopy: 'Jangkauan besar dengan recovery tag lebih cepat.', tagRange: 32, rescueRange: 31, boostMultiplier: 1.66, boostDrain: 29, baseChargeTime: .76, rescueShieldMs: 1500, tagCooldownMs: 410 },
  { id: 'tui', name: 'Tui', role: 'Runner', speed: 230, boost: 96, agility: 1.17, visualScale: 0.94, accent: '#ef3f43', copy: 'Sprinter Tim Merah dengan akselerasi kuat untuk membuka serangan.', passiveName: 'Start Meledak', passiveCopy: 'Sprint Space mencapai kecepatan puncak lebih cepat.', tagRange: 28, rescueRange: 32, boostMultiplier: 1.78, boostDrain: 32, baseChargeTime: .65, rescueShieldMs: 1500, tagCooldownMs: 480 },
  { id: 'lui', name: 'Lui', role: 'Scout', speed: 226, boost: 104, agility: 1.19, visualScale: 0.93, accent: '#42d875', copy: 'Pengintai Tim Hijau yang unggul menyelinap melalui jalur sempit.', passiveName: 'Jalur Sunyi', passiveCopy: 'Sprint stabil dengan kendali parkour yang presisi.', tagRange: 28, rescueRange: 35, boostMultiplier: 1.72, boostDrain: 29, baseChargeTime: .68, rescueShieldMs: 1750, tagCooldownMs: 480 },
...
export const CHARACTER_PREVIEW_ICONS = Object.freeze(Object.fromEntries(
  Object.entries(CHARACTER_PREVIEW_ICON_FILES).map(([id, file]) => [id, `${publicBase}ui-v2/character-icons/${file}.webp?v=8`]),
...
export const characterAsset = (id: CharacterId, file: 'atlas.webp' | 'atlas-runtime.webp' | 'portrait.webp' | 'animations.json') =>
  `${publicBase}characters/${id}/${file}?v=${id === 'jago' || id === 'lala' ? 10 : 9}`;
