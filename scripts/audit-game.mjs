...
assert(prototypeSource.includes('scaleLayout: true') && prototypeSource.includes('field.scaleLayout ? Math.round(value * scaleX)') && prototypeSource.includes('item.hidden || !isNearby'), 'layout dan collider Map 2 diskalakan 15% bersama visual tanpa menggambar collider bantu');
