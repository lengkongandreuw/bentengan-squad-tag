...
assert(fieldManifest.version === 7 && Object.keys(fieldManifest.objects.assets).length === 75, 'manifest field v7 memuat 75 objek statis serta terrain Map 1, Map 2, dan Map 3');
...
assert(fieldObjects.width === 2048 && fieldObjects.height === 2176 && fieldObjects.hasAlpha, 'atlas objek statis v7 2048×2176 transparan dan terpotong rapat');
...
assert(fieldRuntimeBytes <= 2900 * 1024, `enam aset field ${(fieldRuntimeBytes / 1024).toFixed(0)} KiB berada dalam budget 2.900 KiB`);
...
assert(fieldBaseline.version === 7, 'golden baseline field v7 mencakup sumber Map 1, Map 2, dan Map 3 final');
